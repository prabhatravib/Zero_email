  ...
  links: [
    ...
    httpBatchLink({
      ...
      headers: () => {
        ...
        console.log('🔍 tRPC Client - Session token from localStorage:', sessionToken);
        console.log('🔍 tRPC Client - Session token length:', sessionToken?.length || 0);
        console.log('🔍 tRPC Client - Session token type:', typeof sessionToken);
