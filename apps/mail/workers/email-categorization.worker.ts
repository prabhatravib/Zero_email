...
self.addEventListener('message', (event) => {
  ...
  console.log('🔧 Worker: Received message:', message.type, 'batchId:', message.batchId);
  
  if (message.type === 'CATEGORIZE_EMAILS') {
    processEmailBatch(message.emails, message.batchId);
  }
});
